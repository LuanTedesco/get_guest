...
class SponsorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsor" do
    assert_difference("Sponsor.count") do
      post sponsors_url, params: { sponsor: { name: @sponsor.name, type_invite: @sponsor.type_invite } }
    end
  ...
  test "should update sponsor" do
    patch sponsor_url(@sponsor), params: { sponsor: { name: @sponsor.name, type_invite: @sponsor.type_invite } }
