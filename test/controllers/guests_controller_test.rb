...
class GuestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guest" do
    assert_difference("Guest.count") do
      post guests_url, params: { guest: { name: @guest.name, type_invite: @guest.type_invite } }
    end
  ...
  test "should update guest" do
    patch guest_url(@guest), params: { guest: { name: @guest.name, type_invite: @guest.type_invite } }
